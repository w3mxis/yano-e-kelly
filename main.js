...
var i = 0;
var txt1 = "Oii, minha princesa...! << Agora eu quero dizer algo para você. <<< Então, por favor, leia tudo com atenção e dê play na música aaaaa...!                                                                            > Quando te vi pela primeira vez < Não tive como não me apaixonar por você. <<                  Conforme os dias passam < você se aproxima mais de mim....! <<                           Não sei a razão pela qual você ressoam em minha mente...!                                                     > E, aqui estamos completando mais um mês juntos, é sempre uma alegria poder acordar e saber que tenho você ao meu lado e sentir que isso será para sempre é magnífico > você é a melhor coisa que me aconteceu, obrigado por me escolher todos os dias. > Tudo em você é sempre interessante para mim...!                     << Estou um pouco nervoso porque eu a inda fico nervoso em dizer as coisas à você...!                                                     > Eu amo cada detalhe seu, seu cacbelo, seu sorriso, seu cheiro, eu amooo você por completa...!                    << Você me tem por completo meu bem, e lembre-se sempre disso, sinto saudades todas as noites quando tenho que ir pra casa e te deixar....                                                             >Eu amo vc < Meu amor.....!     << E sou muito feliz com você ao meu lado, Te amo muito! &hearts;. Feliz 0.6 Minha Princesa!";
var speed = 60;
typeWriter();
function typeWriter() {
  if (i < txt1.length) {        
